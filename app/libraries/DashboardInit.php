...
class DashboardInit {
	...
	public function __construct(){
		$this->panelItems = array(
                    ...
                    "communication"=>array("title"=>"Communication","icon"=>"mdi mdi-currency-usd","activated"=>"paymentsAct","cusPerm"=>"Communication","permissions"=>array('admin','student','parent','account'),
														"children"=>array(
									...
									#"transportations"=>array("title"=>"Transportation","url"=>URL::to('#/transports'),"icon"=>"mdi mdi-bus","activated"=>"transportAct","cusPerm"=>"Transportation","permissions"=>array('admin','teacher','student','parent') ),
                                                                        ...
                                                                        "classes"=>array("title"=>"classes","url"=>URL::to('#/classes'),"icon"=>"mdi mdi-sitemap","cusPerm"=>"classes","permissions"=>array('admin') ),							
